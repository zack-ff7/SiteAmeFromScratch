...
<div id="discipline">
    ...
    <form method="POST">
        ...
        <textarea name="editorDiscipline" id="editorDiscipline"><?php if(isset($data))
        {
            echo $data;
        }?></textarea>
        ...
        ?>
        <textarea disabled="true" name="editorDiscipline" id="editorDiscipline"><?php if(isset($data))
        {
            echo $data;
        }?></textarea>
        <?php
